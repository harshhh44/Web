...
const navbarBlurStyle = computed(() => {
  const blurValue = isScrolled.value ? '16px' : '20px'
  return {
...
<template>
  <header :class="['navbar', { 'navbar--scrolled': isScrolled }]" :style="navbarBlurStyle">
...
.navbar {
  ...
  background: rgba(255, 246, 253, 0.4);
}

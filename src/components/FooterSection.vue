  ...
  <footer class="footer">
    <div class="container footer__inner">
      ...
      <div class="footer__brand">
        <a href="/" class="footer__logo-link" aria-label="Alva home">
          <img src="/logo.svg" alt="" width="28" height="28" loading="lazy" />
          <span class="footer__wordmark">Alva</span>
        </a>
    ...
    <div class="container footer__bottom">
      <p class="footer__disclaimer">
        Alva is an open-source project (GNU), strictly for educational purposes.
        ...
        Once available, the website download link will be updated. Estimated time is a few months.
      </p>
      <p class="footer__credits">
        Alva made by <a href="https://www.instagram.com/chvxra_lx?igsh=OXBwcHE1cDE4cWEz" target="_blank" rel="noopener noreferrer">André
          Miguel</a>, Site made by <a href="https://www.instagram.com/chvxra_lx?igsh=OXBwcHE1cDE4cWEz" target="_blank" rel="noopener noreferrer">André Miguel</a>
      </p>
    </div>
  </footer>
</template>
...
const links = [
  ...
  { label: 'Github', href: 'https://github.com/amiguel77' }
]
</script>
